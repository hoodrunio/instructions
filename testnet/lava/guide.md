...
![alt text](https://i.hizliresim.com/ptk0s1h.png)

Yukarıdaki gibi log çıktıları görürseniz bu nodeunuzun ağa bağlanmaya çalıştığını ve bunun için peer aradığını gösterir. Eğer 3-5dk'da ağa nodeunuz bağlanmazsa aşağıdaki kodda olduğu gibi başka peerler eklemeniz gerekebilir. Buradaki kodu peerleri ve .lava/config/config.toml kodundaki .lava klasörünü başka katıldığınız projeye göre ayarlayarak o projede de kullanabilirsiniz.
